      ...
      <main className="container mx-auto max-w-[750px] h-full overflow-scroll flex items-center justify-center md:py-4">
        <div className="bg-white w-full h-full overflow-scroll md:rounded-lg z-20 drop-shadow-lg p-2 flex flex-col gap-3">
          ...
          <section className="flex flex-col items-center justify-between">
            <form id="accountUpdate" className="container flex flex-col gap-2 items-center flex-wrap p-2">
              <div id="userInfo" className="grid gap-x-6 gap-y-4 grid-cols-6 w-full  p-2">
                ...
                <div className="col-span-full md:col-span-6">
                  <div className="w-full text-center flex items-center justify-center flex-col py-2">
                    <div className="">
                      <button className="bg-grean text-white font-medium rounded-md p-2">
              ...
              {isBusiness && (
                <div
                  id="userBuisnessInfo"
                  className=" p-2 w-full grid gap-x-6 gap-y-4 grid-cols-6"
                >
              ...
              {!isBusiness && (
                <div
                  id="driverInfo"
                  className="w-full grid gap-x-6 gap-y-4 grid-cols-6 p-2"
                >
                  <div className="col-span-full">
                    <h2 className="text-base font-semibold leading-7 text-gray-900">
                      Driver Information
              ...
              <div id="submitInfo">
                <button
                  type="submit"
                  className="rounded-md bg-red-400 text-white px-4 p-2"
