  ...
  return (
    ...
    >
      ...
      <main className="container mx-auto max-w-[650px] h-full overflow-scroll flex items-center justify-center md:py-4">
        <div className="bg-white w-full h-full overflow-scroll md:rounded-lg z-20">
          <header className="w-full flex items-center justify-center gap-3 p-2">
            ...
            <div>
              ...
              <p className="text-sm bg-grean text-white font-bold px-2 py-2 rounded-xl flex flex-wrap">
                ID:{user.uid}
              </p>
            </div>
          </header>
            ...
            <form className="container mx-auto flex flex-col items-center flex-wrap">
              <div className="py-2">
                ...
                <div className="grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">
                    ...
                    <div className="w-full text-center flex items-center justify-center flex-col">
                      <div className="w-full bg-grean rounded-md py-2">
                        <div className="">
                          ...
                          <input onChange={(e) => {setIsBusiness(e.target.checked)}}
                  ...
                  <button
                    type="submit"
                    className="rounded-md bg-orange px-2 p-1"
