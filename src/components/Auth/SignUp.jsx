...
function SignUp() {
  ...
  return (
    <div className="sm:mx-auto sm:w-full sm:max-w-sm bg-white p-4 py-12 rounded-md md:mt-4">
    ...
    <div className="mt-8">
      <form className="space-y-4" onSubmit={SignUp}>
        ...
        <div className="w-full flex items-center justify-end">
          <button type="submit" className="bg-[#75B657] drop-shadow-2xl rounded-xl w-24 p-1 text-lg text-white shadow-2xl">Sign Up</button>
        </div>
      </form>
