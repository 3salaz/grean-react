...
function SignUp() {
  ...
  return (
    ...
    <div className="sm:mx-auto sm:w-full sm:max-w-sm bg-white px-4 pb-4 pt-12 rounded-md md:mt-4">
      ...
      <div className="w-full flex items-center justify-center gap-8 py-8">
        <button className="bg-white border-2 rounded-lg w-16 h-16">Google</button>
        <button className="bg-white border-2 rounded-lg w-16 h-16">Facebook</button>
        <button className="bg-white border-2 rounded-lg w-16 h-16">Twitter</button>
      </div>
    </div>
    </div>
  );
