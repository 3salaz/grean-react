function Contact() {
  return (
    <section className="relative z-10 overflow-hidden bg-white py-20 w-full h-full">
      <div className="container mx-auto">
        <div className="-mx-4 flex flex-wrap lg:justify-between">
          <div className="w-full px-4 lg:w-1/2 xl:w-6/12 text-center flex items-center justify-center md:block">
